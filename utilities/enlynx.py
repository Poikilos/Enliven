...
Examples:
# label:
    enlynx.py not_minetest_game
# Use a different binary name or path other than lynx:
    enlynx.py not_minetest_game --browser surfraw
# label and page number:
    enlynx.py not_minetest_game page 2
# multiple labels:
    enlynx.py not_minetest_game urgent
# closed issues only:
    enlynx.py not_minetest_game --closed
# both closed and open issues:
    enlynx.py not_minetest_game --closed --open
# search:
...
# label with search:
    enlynx.py not_minetest_game find mobs
# label with search, next page:
    enlynx.py not_minetest_game find node page 2
...
base_url = "https://github.com/Poikilos/Enliven"
